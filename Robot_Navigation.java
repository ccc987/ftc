...
// List of active targets
    ...
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot) {
        ...
        //OR... Use this line to improve performance

        VuforiaLocalizer.Parameters parameters = new VuforiaLocalizer.Parameters(myRobot.cameraMonitorViewId);
        ...
        parameters.cameraName = myRobot.webcamName;
